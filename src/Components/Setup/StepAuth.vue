...
const success_html = `<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><title>StreamLurker &bull; Auth Complete</title><meta name="viewport" content="width=device-width, initial-scale=1.0"><style>html, body {margin: 0;padding: 0;background: #0f172a;color: #f1f5f9;font-family: "Segoe UI", Tahoma, Geneva, Verdana, sans-serif;height: 100vh;display: flex;align-items: center;justify-content: center;flex-direction: column;text-align: center;}.check {font-size: 4rem;color: #10b981;margin-bottom: 1rem;}.message {font-size: 1.25rem;max-width: 24rem;}.logo {margin-bottom: 1rem;font-size: 1.75rem;font-weight: bold;color: #38bdf8;}</style></head><body><div class="logo">StreamLurker</div><div class="check">✔️</div><div class="message">Twitch authentication complete!<br><br>You can now return to <strong>StreamLurker</strong> and close this window.</div></body></html>`;
